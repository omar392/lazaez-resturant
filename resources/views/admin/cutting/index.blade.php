        ...
        <div class="container-fluid">
            ...
            <div class="page-title-box">
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <h4 class="page-title" style="font-family: cairo;">طرق التقطيع</h4>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-right">
                            <li class="breadcrumb-item"><a href="{{ route('adminhome') }}">الرئيسية</a></li>
                            <li class="breadcrumb-item active">طرق تقطيع</li>
                        </ol>
                    </div>
                </div> <!-- end row -->
                <br>
                <div class="row align-items-center">
                    @if (Auth::guard('admin')->user()->hasPermission('cuttings-create'))
                        <div class="text-center">
                            <!-- Large modal -->
                            <button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal"
                                data-target=".bs-example-modal-lg"><i class="fas fa-plus-circle"></i>إضافة طريقة
                                جديدة</button>
                        </div>
                    @endif
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" name="name_ar"
                                                        id="example-text-input" placeholder="التقطيع " required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="example-text-input"
                                                    class="col-sm-2 col-form-label">Cutting</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" name="name_en" id="example-text-input"
                                    ...
                                    <tbody>
                                        @foreach ($cutting as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    @if (Auth::guard('admin')->user()->hasPermission('cuttings-update'))
                                                    ...
                                                    @endif
                                                    &ensp;
                                                    @if (Auth::guard('admin')->user()->hasPermission('cuttings-delete'))
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title mt-0" id="myLargeModalLabel"
                                                                style="font-family: cairo;">تعديل طرق التقطيع</h5>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="card-body">
                                                                <form action="{{ route('cutting.update', $item->id) }}"
