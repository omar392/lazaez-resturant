                                ...
                                <div class="modal-body">
                                    <div class="card-body">
                                        <form action="{{ route('cutting.store') }}" method="POST"
                                            ...
                                            <div class="form-group row">
                                                <label for="example-text-input" class="col-sm-2 col-form-label">Cutting</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" name="name_en"
                                                        id="example-text-input" placeholder="Cutting" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="example-text-input"
                                        ...
                                        @foreach ($cutting as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('cutting.edit', $item->id) }}"><button type="button"
                                                    ...
                                                    <form class="float-left ml-1"
                                                        action="{{ route('cutting.destroy', $item->id) }}" method="POST">
                                                        @csrf
                                                        @method('delete')
