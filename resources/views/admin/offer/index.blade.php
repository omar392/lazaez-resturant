                                              ...
                                              <div id="myModal{{ $item->id }}" class="modal fade" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="card-body">
                                                                <form action="{{ route('offer.update', $item->id) }}"
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            <input class="form-control" type="text" name="name_ar"
                                                                                id="example-text-input" placeholder="عنوان الاعلان" value="{{$item->name_ar}}" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        <label for="example-text-input" class="col-sm-2 col-form-label">Offer Name</label>
                                                                        <div class="col-sm-10">
                                                                            <input class="form-control" name="name_en"
                                                                                id="example-text-input" placeholder="offer Title" value="{{$item->name_en}}" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        <label for="example-text-input"
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            <textarea class="form-control" name="description_ar" id="editor{{ $item->id }}+6">{!! $item->description_ar !!}</textarea>
                                                                        <script>
                                                                                CKEDITOR.replace( 'editor{{ $item->id }}+6' );
                                                                        </script>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="example-text-input" class="col-sm-2 col-form-label">السعر</label>
                                                                        <div class="col-sm-10">
                                                                            <input class="form-control" type="number" name="main_price" value="{{$item->main_price}}"
                                                                                id="example-text-input" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <img src="{{asset('upload/offer/' . $item->image)}}">
                                                                            </div>
                                                                            <div class="fileContainer sprite">
                                                                            <span>اضف صورة جديدة</span>
                                                                            <input type="file" name="image" value="{{url('upload/offer/' . $item->image)}}">
                                                                    </div>
