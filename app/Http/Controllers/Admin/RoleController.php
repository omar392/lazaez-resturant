...
class RoleController extends Controller
{
    ...
    {
        $models = ['admins','faqs','teams','users','wrappings','spices','cookings','countries','cities','cuttings','roles','offers','opinions','categories','banners','adverts','products','settings','abouts'];
